...
class Remise_frm6 extends StatelessWidget {
  static String routeName = "/Remise_frm6";
                                  ...
                                  return Container(
                                    child: Column(
                                      children: [
                                        ...
                                        Text("------------------"),
                                        Image.asset(
                                          'lib/images/remise_frm 6 sch1.png',
                                          width:
                                  ...
                                  return Container(
                                    child: Column(
                                      children: [
                                        ...
                                        Text("------------------"),
                                        Image.asset(
                                          'lib/images/remise_frm 6 sch2.png',
                                          width:
                                              MediaQuery.of(context).size.width,
                                        ),
                                        SizedBox(height: 16.0),
                                  ...
                                  return Container(
                                    child: Column(
                                      children: [
                                        ...
                                        Text("------------------"),
                                        Image.asset(
                                          'lib/images/remise_frm 6 sch3.png',
                                          width:
                                              MediaQuery.of(context).size.width,
                                        ),
                                        SizedBox(height: 16.0),
                                  ...
                                  return Container(
                                    child: Column(
                                      children: [
                                        ...
                                        Text("------------------"),
                                        Image.asset(
                                          'lib/images/remise_frm 6 sch4.png',
                                          width:
                                              MediaQuery.of(context).size.width,
                                        ),
                                        SizedBox(height: 16.0),
                                  ...
                                  return Container(
                                    child: Column(
                                      children: [
                                        ...
                                        Text("------------------"),
                                        Image.asset(
                                          'lib/images/remise_frm 6 sch5.png',
                                          width:
                                              MediaQuery.of(context).size.width,
                                        ),
                                        SizedBox(height: 16.0),
                                  ...
                                  return Container(
                                    child: Column(
                                      children: [
                                        ...
                                        Text("------------------"),
                                        Image.asset(
                                          'lib/images/remise_frm 6 sch6.png',
                                          width:
                                              MediaQuery.of(context).size.width,
                                        ),
                                        SizedBox(height: 16.0),
